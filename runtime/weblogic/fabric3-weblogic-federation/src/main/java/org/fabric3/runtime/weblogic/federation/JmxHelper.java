...
public interface JmxHelper {
    ...
    /**
     * Returns the value of the given JMX attribute under the WebLogic runtime MBean.
     *
     * @param clazz the expected type of the value
     * @param name  the attribute name, which includes the MBean hierarchy delimited by '/'
     * @return the value
