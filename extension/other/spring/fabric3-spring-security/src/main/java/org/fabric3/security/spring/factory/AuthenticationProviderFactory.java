...
public interface AuthenticationProviderFactory {
    ...
    /**
     * Instantiates a collection of Spring <code>AuthenticationProvider</code>s.
     *
     * @param configuration the configuration to instantiate from
     * @return the collection of Spring <code>AuthenticationProvider</code>s.
     */
    List<AuthenticationProvider> create(AuthenticationManagerConfiguration configuration);
}