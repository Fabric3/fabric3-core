 ...
 */
public class MultiThreadedEntityManagerProxyFactory implements Supplier<MultiThreadedEntityManagerProxy> {
    ...
    public MultiThreadedEntityManagerProxy get() throws Fabric3Exception {
