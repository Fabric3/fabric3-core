 ...
 */
public class StatefulEntityManagerProxyFactory implements Supplier<StatefulEntityManagerProxy> {
    ...
    public StatefulEntityManagerProxy get() throws Fabric3Exception {
