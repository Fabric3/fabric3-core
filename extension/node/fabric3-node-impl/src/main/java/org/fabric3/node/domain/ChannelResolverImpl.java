...
public class ChannelResolverImpl implements ChannelResolver {
    ...
    public ChannelResolverImpl(@Reference ChannelProxyService proxyService) {
        this.proxyService = proxyService;
    }

    public <T> T resolve(Class<T> interfaze, String name) throws ResolverException {
        throw new UnsupportedOperationException();
        //  ProducerCommandGenerator
        //  ChannelConnector
        // ChannelConnection connection = null;
        // return proxyService.createObjectFactory(interfaze, connection).getInstance();
    }
