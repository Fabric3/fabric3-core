...
public class ZoneProvisionCommandExecutor extends AbstractProvisionCommandExecutor {
    ...
    public ZoneProvisionCommandExecutor(@Reference ServletHost host, @Reference CommandExecutorRegistry registry, @Reference ArtifactCache cache) {
        super(host, registry);
        this.cache = cache;
    }

    protected HttpServlet getResolverServlet() {
        return new ArtifactCacheResolverServlet(cache);
    }
}