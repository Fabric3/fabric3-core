 ...
 */
public class ZeroMQWireTargetDefinition extends PhysicalWireTargetDefinition {
     ...
     */
    public ZeroMQWireTargetDefinition(URI uri, ZeroMQMetadata metadata) {
     ...
     * @param metadata    the ZeroMQ metadata to configure the underlying socket
     */
    public ZeroMQWireTargetDefinition(URI uri, URI callbackUri, ZeroMQMetadata metadata) {
        this.metadata = metadata;
        setUri(uri);
