...
public class ZeroMQTransport implements Transport {
    ...
    public ZeroMQTransport(@Reference ZeroMQPubSubBroker pubSubBroker, @Reference ZeroMQWireBroker wireBroker) {
        this.pubSubBroker = pubSubBroker;
        this.wireBroker = wireBroker;
    }

    public void suspend() {
        wireBroker.stopAll();
        pubSubBroker.stopAll();
    }

    public void resume() {
        wireBroker.startAll();
        pubSubBroker.startAll();
    }
}
