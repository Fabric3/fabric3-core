 ...
 *
 */
public class CallbackTargetAddressHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    public CallbackTargetAddressHandler() {
    }
    ...
    public boolean handleMessage(SOAPMessageContext soapContext) {
        ...
        try {
            ...
            SOAPHeader forwardHeader = workContext.getHeader(SOAPHeader.class, "f3.forward.header");
    ...
    private void setReturnAddress(SOAPElement element, WorkContext context) {
