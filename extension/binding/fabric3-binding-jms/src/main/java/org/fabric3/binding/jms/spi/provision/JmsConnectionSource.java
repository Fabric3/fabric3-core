 ...
 */
public class JmsConnectionSource extends PhysicalConnectionSourceDefinition {
     ...
     */
    public JmsConnectionSource(URI uri, JmsBindingMetadata metadata, DataType type, SessionType sessionType) {
        super(type);
