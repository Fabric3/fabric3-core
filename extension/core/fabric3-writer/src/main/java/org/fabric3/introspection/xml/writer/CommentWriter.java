...
/**
 * Serializes a comment to a StAX stream.
 */
@EagerInit
public class CommentWriter extends AbstractTypeWriter<Comment> {
    ...
    public void write(Comment comment, XMLStreamWriter xmlWriter) throws XMLStreamException {
        xmlWriter.writeComment(comment.getComment());
    }
