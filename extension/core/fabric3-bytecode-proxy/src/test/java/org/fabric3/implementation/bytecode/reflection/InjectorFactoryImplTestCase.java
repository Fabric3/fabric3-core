 ...
 *
 */
public class InjectorFactoryImplTestCase extends TestCase {
    private InjectorFactoryImpl factory;
    private BytecodeClassLoader classLoader;


    public void testProtectedFieldInject() throws Exception {
        Field field = InjectorClass.class.getDeclaredField("field");
        ...
        BytecodeInjector injector = factory.createInjector(field, objectFactory, classLoader);

        InjectorClass target = new InjectorClass();

        injector.inject(target);

        assertEquals("test", target.field);
    }
    ...
    public void testMethodInject() throws Exception {
        ...
        BytecodeInjector injector = factory.createInjector(method, objectFactory, classLoader);
