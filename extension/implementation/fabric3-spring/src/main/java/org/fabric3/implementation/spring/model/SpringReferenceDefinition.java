...
public class SpringReferenceDefinition extends ReferenceDefinition {
    ...
    public SpringReferenceDefinition(String name, ServiceContract serviceContract, String defaultValue) {
        super(name, serviceContract);
        this.defaultValue = defaultValue;
        if (defaultValue != null) {
            setMultiplicity(Multiplicity.ZERO_ONE);  // set to 0..N since the default value may be wired
        }
    }
