 ...
 */
public class SpringConnectionTarget extends PhysicalConnectionTarget {
     ...
     */
    public SpringConnectionTarget(String beanName, String methodName, JavaType type, URI channelUri) {
