...
public abstract class XQueryComponent implements AtomicComponent {
    ...
    public abstract void attachSourceWire(String name, String callbackUri, Wire wire) throws BuilderException;

    public abstract void attachTargetWire(String name, Wire wire) throws BuilderException;
