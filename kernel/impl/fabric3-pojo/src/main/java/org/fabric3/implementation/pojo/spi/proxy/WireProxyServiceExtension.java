...
public interface WireProxyServiceExtension {
    ...
    /**
     * Returns true if the implementation is the default.
     *
     * @return true if the implementation is the default
     */
    boolean isDefault();

    /**
     * Create a Supplier that provides proxies for the forward wire.
     *
    ...
    /**
     * Create a Supplier that provides proxies for the callback wire.
     *
     * @param interfaze     the interface the proxy implements
