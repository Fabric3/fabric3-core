...
public class ProducerCommandGeneratorTestCase extends TestCase {
    ...
    public void testGenerateIncrementalAttach() throws Exception {
        ...
        EasyMock.expect(connectionGenerator.generateProducer(EasyMock.isA(LogicalProducer.class))).andReturn(list);
        EasyMock.replay(connectionGenerator);

        ProducerCommandGenerator generator = new ProducerCommandGenerator(connectionGenerator, 0);
