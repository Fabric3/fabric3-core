...
public class ProvisionExtensionsCommandTestCase extends TestCase {
    private static final URI EXTENSION_URI = URI.create("extension");
    private ProvisionExtensionsCommand command;

    public void testCompensatingCommand() throws Exception {
        UnProvisionExtensionsCommand compensating = command.getCompensatingCommand();
