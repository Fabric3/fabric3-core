...
public class SerializationServiceTestCase extends TestCase {
    ...
    public void testSerializeDeserialize() throws Exception {
        ...
        SerializationServiceImpl service = new SerializationServiceImpl(registry);
        byte[] bytes = service.serialize("test");
        assertEquals("test", service.deserialize(String.class, bytes));
