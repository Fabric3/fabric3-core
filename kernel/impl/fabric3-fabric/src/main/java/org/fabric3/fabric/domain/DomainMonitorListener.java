...
/**
 * Listener that sends deployment and undeployment events to a monitor.
 *
 * @version $Rev$ $Date$
 */
public class DomainMonitorListener implements DomainListener {
    ...
    public DomainMonitorListener(@Monitor DomainMonitor monitor) {
        this.monitor = monitor;
    }

    public void onInclude(QName deployable, String plan) {
