...
import org.fabric3.fabric.deployment.executor.AttachChannelConnectionCommandExecutor;
import org.fabric3.fabric.deployment.executor.AttachExtensionCommandExecutor;
import org.fabric3.fabric.deployment.executor.AttachWireCommandExecutor;
import org.fabric3.fabric.deployment.executor.BuildChannelCommandExecutor;
import org.fabric3.fabric.deployment.executor.BuildComponentCommandExecutor;
import org.fabric3.fabric.deployment.executor.BuildResourcesCommandExecutor;
import org.fabric3.fabric.deployment.executor.ChannelConnectionCommandExecutor;
import org.fabric3.fabric.deployment.executor.ConnectionCommandExecutor;
import org.fabric3.fabric.deployment.executor.DetachChannelConnectionCommandExecutor;
import org.fabric3.fabric.deployment.executor.DetachExtensionCommandExecutor;
import org.fabric3.fabric.deployment.executor.DetachWireCommandExecutor;
import org.fabric3.fabric.deployment.executor.DisposeChannelCommandExecutor;
import org.fabric3.fabric.deployment.executor.DisposeComponentCommandExecutor;
import org.fabric3.fabric.deployment.executor.DisposeResourcesCommandExecutor;
import org.fabric3.fabric.deployment.executor.ProvisionClassloaderCommandExecutor;
import org.fabric3.fabric.deployment.executor.ProvisionExtensionsCommandExecutor;
import org.fabric3.fabric.deployment.executor.ProvisionedExtensionTrackerImpl;
...
import org.fabric3.fabric.deployment.executor.StopComponentCommandExecutor;
import org.fabric3.fabric.deployment.executor.StopContextCommandExecutor;
import org.fabric3.fabric.deployment.executor.UnProvisionExtensionsCommandExecutor;
import org.fabric3.fabric.deployment.executor.UnprovisionClassloaderCommandExecutor;
import org.fabric3.fabric.deployment.generator.binding.BindingSelectorImpl;
import org.fabric3.fabric.deployment.generator.binding.ConfigurableBindingSelectionStrategy;
import org.fabric3.fabric.deployment.generator.channel.ChannelCommandGeneratorImpl;
import org.fabric3.fabric.deployment.generator.channel.ChannelGeneratorImpl;
import org.fabric3.fabric.deployment.generator.channel.ConnectionGeneratorImpl;
import org.fabric3.fabric.deployment.generator.channel.ConsumerCommandGenerator;
import org.fabric3.fabric.deployment.generator.channel.DefaultChannelGeneratorExtensionImpl;
import org.fabric3.fabric.deployment.generator.channel.ProducerCommandGenerator;
import org.fabric3.fabric.deployment.generator.classloader.ClassLoaderCommandGeneratorImpl;
import org.fabric3.fabric.deployment.generator.collator.ContributionCollatorImpl;
import org.fabric3.fabric.deployment.generator.component.BuildComponentCommandGenerator;
import org.fabric3.fabric.deployment.generator.component.DisposeComponentCommandGenerator;
import org.fabric3.fabric.deployment.generator.component.StartComponentCommandGenerator;
import org.fabric3.fabric.deployment.generator.component.StopComponentCommandGenerator;
import org.fabric3.fabric.deployment.generator.context.StartContextCommandGeneratorImpl;
import org.fabric3.fabric.deployment.generator.context.StopContextCommandGeneratorImpl;
import org.fabric3.fabric.deployment.generator.extension.ExtensionGeneratorImpl;
import org.fabric3.fabric.deployment.generator.impl.GeneratorImpl;
import org.fabric3.fabric.deployment.generator.impl.GeneratorRegistryImpl;
import org.fabric3.fabric.deployment.generator.policy.DefaultPolicyRegistry;
import org.fabric3.fabric.deployment.generator.resource.BuildResourceCommandGenerator;
import org.fabric3.fabric.deployment.generator.resource.DisposeResourceCommandGenerator;
import org.fabric3.fabric.deployment.generator.resource.DomainResourceCommandGeneratorImpl;
import org.fabric3.fabric.deployment.generator.utility.NullInterceptorGenerator;
import org.fabric3.fabric.deployment.generator.wire.BoundServiceCommandGenerator;
import org.fabric3.fabric.deployment.generator.wire.OperationResolverImpl;
import org.fabric3.fabric.deployment.generator.wire.PhysicalOperationGeneratorImpl;
import org.fabric3.fabric.deployment.generator.wire.ReferenceCommandGenerator;
import org.fabric3.fabric.deployment.generator.wire.ResourceReferenceCommandGenerator;
import org.fabric3.fabric.deployment.generator.wire.WireGeneratorImpl;
import org.fabric3.fabric.deployment.instantiator.LogicalModelInstantiatorImpl;
import org.fabric3.fabric.deployment.instantiator.channel.ChannelInstantiatorImpl;
import org.fabric3.fabric.deployment.instantiator.component.AtomicComponentInstantiatorImpl;
import org.fabric3.fabric.deployment.instantiator.component.AutowireNormalizerImpl;
import org.fabric3.fabric.deployment.instantiator.component.CompositeComponentInstantiatorImpl;
import org.fabric3.fabric.deployment.instantiator.promotion.PromotionNormalizerImpl;
import org.fabric3.fabric.deployment.instantiator.promotion.PromotionResolutionServiceImpl;
import org.fabric3.fabric.deployment.instantiator.wire.AutowireInstantiatorImpl;
import org.fabric3.fabric.deployment.instantiator.wire.TypeAutowireResolver;
