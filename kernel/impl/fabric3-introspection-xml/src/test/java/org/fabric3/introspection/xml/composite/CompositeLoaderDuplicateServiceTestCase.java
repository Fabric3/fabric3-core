...
public class CompositeLoaderDuplicateServiceTestCase extends TestCase {
    ...
    public void testDuplicateProperty() throws Exception {
        ...
        assertTrue(((ArtifactValidationFailure) failure).getFailures().get(0) instanceof DuplicatePromotedService);
    }
    ...
    protected void setUp() throws Exception {
        ...
        loader = new CompositeLoader(null, new CompositeServiceLoader(null, loaderHelper), null, null, null, loaderHelper);
