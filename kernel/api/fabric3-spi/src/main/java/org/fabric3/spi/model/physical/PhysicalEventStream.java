 ...
 */
public class PhysicalEventStream {
    private String name;
    private List<Class<?>> eventTypes = new ArrayList<>();
    private List<PhysicalEventFilter> filters = new ArrayList<>();
    private boolean channelEvent;

    public PhysicalEventStream(String name) {
        this.name = name;
    }
    ...
    /**
     * Returns {@link PhysicalEventFilter}s for the stream.
     *
     * @return filter definitions for the stream
     */
    public List<PhysicalEventFilter> getFilters() {
        return filters;
    }

    /**
     * Adds a {@link PhysicalEventFilter}.
     *
     * @param physicalFilter the filter to add
     */
    public void addFilter(PhysicalEventFilter physicalFilter) {
        filters.add(physicalFilter);
    }
