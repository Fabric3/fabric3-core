 ...
 *
 */
public class PhysicalOperationTestCase extends TestCase {

    public void testCompareTo() {
        PhysicalOperation definition1 = createDefinition("foo", String.class);
        PhysicalOperation definition1a = createDefinition("foo", String.class);

        PhysicalOperation definition2 = createDefinition("foo", Integer.class);
        PhysicalOperation definition2a = createDefinition("foo", Integer.class);
    ...
    private PhysicalOperation createDefinition(String name, Class<?> type) {
