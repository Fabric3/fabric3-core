...
public interface Monitorable {
    ...
    /**
     * Returns the name of the monitored instance.
     *
     * @return the name of the monitored instance
     */
    String getName();

    /**
     * Returns the current level used to control event output for this monitorable.
     *
