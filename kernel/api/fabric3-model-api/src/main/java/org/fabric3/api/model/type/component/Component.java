...
public class Component<I extends Implementation<?>> extends ModelObject<Composite> {
    ...
    private Map<String, Service<Component>> services = new HashMap<>();
    private Map<String, Reference<Component>> references = new HashMap<>();
    private Map<String, Producer<Component>> producers = new HashMap<>();
    private Map<String, Consumer<Component>> consumers = new HashMap<>();
